<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
        	...
        	<h3 class="text-center">&Aacute;rbitros Postulados</h3>
        	...
        	<h3 class="text-center">&Aacute;rbitros</h3>
        	<table class="table table-bordered">
        		<thead>
        			<tr class="active">
        				<th>&Aacute;rbitro</th>
